...
import Deskripsi6 from './Deskripsi/Deskripsi6';
                        ...
                        <div className='lg:w-1/2 py-5 rounded-lg'>
                            <div className='mt-24 items-center'>
                                <div className='px-0 lg:px-0'>
                                    ...
                                    Gong Cave, Pacitan, East Java                                   </h1>
                                    <p>Explore Gong Cave in Pacitan, East Java, featuring beautiful stalactite and stalagmite formations. Immerse yourself in the unique wonders of the underground world with a rare "concert" of nature.</p>
                                </div>
                                <div className='mt-5'>
