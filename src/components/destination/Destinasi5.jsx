...
import Deskripsi5 from './Deskripsi/Deskripsi5';
                        ...
                        <div className='lg:w-1/2 py-5 rounded-lg'>
                            <div className='mt-24 items-center'>
                                <div className='px-0 lg:px-0'>
                                    ...
                                    Kampung Naga, Tasikmalaya, West Java                                   </h1>
                                    <p>Visit Kampung Naga, an indigenous village in West Java, boasting traditional bamboo houses and preserving Sundanese traditions. A rare opportunity to experience traditional life and architecture.</p>
                                </div>
                                <div className='mt-5'>
